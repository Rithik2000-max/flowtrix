...
1. [wekan-8.82-win64.zip](https://github.com/wekan/wekan/releases/download/v8.82/wekan-8.82-win64.zip)
...
7. Unzip `wekan-8.82-win64.zip` , inside it is directory `bundle`, to it copy other files:
